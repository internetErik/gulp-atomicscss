...
*/
	var atomParser = (function() {
		...
		parser.getMolecules = function(moleculeArray) {
			...
			//ToDo - make sure we don't filter out the instance with the class definitions
				//Perhaps make every definition to the right/left of the class that classes styles, 
				//this way we can do multiple classes
